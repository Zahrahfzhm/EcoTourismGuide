    ...
    return (
        <section className="bg-[#B9F4E0] min-h-screen">
            <div className="relative w-full h-[350px] bg-black">
                <Image 
                    src="https://images.unsplash.com/photo-1590523277543-a94d2e4eb00b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&q=80" 
            ...
            <div className="flex-col space-y-6">
                <div className="max-w-[1024px] mx-auto flex flex-col space-y-5 mt-6 ml-35 mr-35 text-black font-poppins">
                    ...
                    <div>
                        <h2 className="text-3xl font-semibold">Fasilitas</h2>
                        <div className="grid grid-cols-4 gap-4">
                            <div>
                                <ul className="list-disc list-inside"> 
                                    <li className="ml-8">Lorem</li>
                                    <li className="ml-8">Ipsum</li>
                                    <li className="ml-8">Dolor</li>
                                </ul>
                            </div>
                            <div>
                                <ul className="list-disc list-inside"> 
                    ...
                    <div>
                        <h2 className="text-3xl font-semibold">Lokasi</h2>
                        <p>Lembang, Kabupaten Bandung Barat, Jawa Barat</p>
                    </div>
                    <div>
                        <h2 className="text-3xl font-semibold">Jam Operasional</h2>
                        <div className="grid grid-cols-4">
                            <div>
                                <ul> 
                                    <li className="ml-8">Weekdays</li>
                                    <li className="ml-8">Weekend</li>
                                </ul>
                            </div>
                            <div>
                                <ul> 
                    ...
                    <div>
                        <h2 className="text-3xl font-semibold">Harga Tiket</h2>
                        <p>Rp25.000/orang</p>
                    </div>
                    <div>
                    ...
                    <div>
                        <h2 className="text-3xl font-semibold">Keterangan Tambahan</h2>
                        <ul className="list-decimal list-inside">
                            <li className="ml-4">Ketentuan atau peraturan yang berlaku</li>
                            <li className="ml-4">Hal-hal yang perlu diperhatikan</li>
                            <li className="ml-4">Larangan</li>
                            <li className="ml-4">Contact Person</li>
                        </ul>
            ...
            <div className="flex justify-center gap-4 mx-16"> 
                ...
                <div className="w-6/12 p-4 bg-white rounded-lg shadow-md mb-8">
                    ...
                    <p style={{ color: 'black' }}>Klik untuk membuka Google Maps</p>
                    <button className="bg-green-500 text-white rounded px-4 py-2 mt-2 hover:bg-green-600">Akses Lokasi</button>
                </div>
            </div>
