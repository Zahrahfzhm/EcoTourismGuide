...
export default function DashboardWisatawanContent() {
    return (
        <div className="flex flex-col items-center pl-26 bg-green-200 max-md:pl-10">
            <section className="flex overflow-hidden relative flex-col items-start px-16 py-20 w-full text-white min-h-[755px] max-md:px-5 max-md:max-w-full">
                <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/2ded300463fb133a03f71174cb5678e8092e599e6484ae92ce5c75ff2948b57c?apiKey=59541bf2346a4f44991d05930261be7f&" className="object-cover absolute inset-0 size-full h-11/12" alt="" />
            ...
            <section className="z-10 p-48 pt-2 pb-24 w-full bg-green-200 max-md:px-5 max-md:max-w-full">
                <div className="flex gap-28 max-md:flex-col max-md:gap-0">
                    <section className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                        <article className="flex flex-col grow max-md:mt-10 max-md:max-w-full">
                            <img src="/logo_landscape.png" alt="ECO-TOURISM GUIDE" className="w-[500px] pl-2 mt-8" />
                            <p className="mt-6 text-base font-medium leading-6 text-neutral-600 max-md:max-w-full">
                                Ekowisata atau eco-tourism adalah bentuk wisata yang bertujuan untuk mengunjungi dan menikmati area alami yang belum terjamah, dengan cara yang menjaga kelestarian lingkungan serta mendukung kesejahteraan masyarakat lokal. Anda dapat menikmati keindahan alam sekaligus berkontribusi pada pelestarian lingkungan dan kesejahteraan masyarakat lokal. Selamat berpetualang secara bertanggung jawab!
                            </p>
                            <section className="mt-8 max-md:max-w-full">
                                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                                    <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full transition-transform duration-300 hover:scale-105">
                                        <div className="group flex flex-col grow justify-between px-16 py-10 w-full text-center bg-white rounded-2xl shadow-2xl transition-transform duration-300 transform hover:scale-105 max-md:px-5 max-md:mt-10">
                                            <span className="text-5xl font-semibold text-emerald-500 leading-[56px] transition-transform transform group-hover:scale-110 max-md:text-4xl max-md:leading-[50px]">
                                                <span className="text-stone-950">30</span> +
                                            </span>
                                            <p className="mt-2 text-base font-medium leading-6 text-neutral-600 transition-transform transform group-hover:translate-y-1">
                                                Daerah Wisata
                                            </p>
                                        </div>
                                    </article>
                                    <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full transition-transform duration-300 hover:scale-105">
                                        <div className="group flex flex-col grow justify-between px-16 py-10 w-full text-center bg-white rounded-2xl shadow-2xl transition-transform duration-300 transform hover:scale-105 max-md:px-5 max-md:mt-10">
                                            <span className="text-5xl font-semibold text-emerald-500 leading-[56px] transition-transform duration-300 transform group-hover:scale-110 max-md:text-4xl max-md:leading-[50px]">
                                                <span className="text-stone-950">30</span> +
                                            </span>
                                            <p className="mt-2 text-base font-medium leading-6 text-neutral-600 transition-transform transform group-hover:translate-y-1">
                                                Daerah Wisata
                            ...
                            <section className="mt-6 max-md:max-w-full">
                                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                                    <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full transition-transform duration-300 hover:scale-105">
                                        <div className="group flex flex-col grow justify-between px-16 py-10 w-full text-center bg-white rounded-2xl shadow-2xl transition-transform duration-300 transform hover:scale-105 max-md:px-5 max-md:mt-10">
                                            <span className="text-5xl font-semibold text-emerald-500 leading-[56px] transition-transform duration-300 transform group-hover:scale-110 max-md:text-4xl max-md:leading-[50px]">
                                                <span className="text-stone-950">6K</span> +
                                            </span>
                                            <p className="mt-2 text-base font-medium leading-6 text-neutral-600 transition-transform transform group-hover:translate-y-1">
                                                Kuliner Daerah
                                            </p>
                                    ...
                                    <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full transition-transform duration-300 hover:scale-105">
                                        <div className="group flex flex-col grow justify-between px-16 py-10 w-full text-center bg-white rounded-2xl shadow-2xl transition-transform duration-300 transform hover:scale-105 max-md:px-5 max-md:mt-10">
                                            <span className="text-5xl font-semibold text-emerald-500 leading-[56px] transition-transform duration-300 transform group-hover:scale-110 max-md:text-4xl max-md:leading-[50px]">
                                                <span className="text-stone-950">99</span> +
                                            </span>
                                            <p className="mt-2 text-base font-medium leading-6 text-neutral-600 transition-transform transform group-hover:translate-y-1">
                                                Penghargaan
                                            </p>
            ...
            <div className="flex flex-col px-10 pt-2 pb-10 w-full bg-slate-800 max-md:px-5 max-md:max-w-full">
                ...
                <section className="self-center mt-9 w-full max-w-[1350px] max-md:max-w-full">
                ...
                <section className="self-center mt-10 w-full max-w-[1350px] max-md:max-w-full">
                    <div className="flex gap-10 max-md:flex-col max-md:gap-0">
                        <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                            <Cardconten
                        ...
                        <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                            <Cardconten
                                ...
                                title="Menikmati Wisata dengan Lebih Banyak Kenangan: Tips dan Trik Berpetualang"
                ...
                <div className="flex justify-center">
                    <a href="http://localhost:3000/Wisatawan/listkonten">
                        <button className="px-8 py-5 mt-20 mb-10 text-lg font-bold leading-6 text-white whitespace-nowrap bg-emerald-500 rounded-lg max-md:px-5 max-md:mt-10">
                            Lainnya
                        </button>
                    </a>
                </div>
            </div>
            <section className="flex flex-col justify-center px-5 py-20 w-full bg-white max-md:max-w-full">
                <header className="self-center text-6xl font-bold text-center text-cyan-900 leading-[67.2px] max-md:max-w-full max-md:text-4xl">
                    Rekomendasi Wisata
                </header>
                <section className="flex justify-center items-center w-full mt-12 max-w-[1500px] mb-20 max-md:max-w-full mx-auto flex-col w-full">
                ...
                <div className="flex justify-center">
                    <a href="#">
                        <button className="px-8 py-5 mt-8 mb-10 text-lg font-bold leading-6 text-white whitespace-nowrap bg-emerald-500 rounded-lg max-md:px-5 max-md:mt-10">
                            Lainnya
                        </button>
                    </a>
                </div>
            </section>
            <div className="flex flex-col w-full max-w-[1500px] max-md:mt-50 mt-20 mb-20 max-md:max-w-full">
                <section className="overflow-hidden relative flex-col justify-center items-center self-center px-16 pt-36 pb-28 w-full text-7xl font-semibold leading-10 text-center text-white whitespace-nowrap shadow-sm max-w-[1774px] min-h-[320px] rounded-[10px] max-md:px-5 max-md:max-w-full max-md:text-4xl">
                    <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/450207660d965ec5891122f15a44fc7b99af07f14578857049223fdf96f935dd?apiKey=59541bf2346a4f44991d05930261be7f&" alt="" className="object-cover absolute inset-0 size-full" />
