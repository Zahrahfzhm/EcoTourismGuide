    ...
    return (
        ...
        <div className="max-w-[1024px] mx-auto p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-white rounded-lg shadow-lg p-5 h-85 flex flex-col">
                    <Image src="/Bandung.jpg" alt="Taman Safari" width={700} height={400} className="h-48 w-full object-cover rounded-t-lg"/>
                    ...
                    <button className="mt-4 bg-green-500 text-white rounded px-4 py-2 hover:bg-green-600">Lihat Detail</button>
                </div>
                <div className="bg-white rounded-lg shadow-lg p-5 h-85 flex flex-col">
                    <Image src="/Lampung.jpg" alt="Arung Jeram" width={700} height={400} className="h-48 w-full object-cover rounded-t-lg"/>
                ...
                <div className="bg-white rounded-lg shadow-lg p-5 h-85 flex flex-col">
                    <Image src="/Malang.jpg" alt="Spa Bali" width={700} height={400} className="h-48 w-full object-cover rounded-t-lg"/>
                ...
                <div className="bg-white rounded-lg shadow-lg p-5 h-85 flex flex-col">
                    <Image src="/Semarang.jpg" alt="Museum Daerah" width={700} height={400} className="h-48 w-full object-cover rounded-t-lg"/>
                ...
                <div className="bg-white rounded-lg shadow-lg p-5 h-85 flex flex-col">
                    <Image src="/Yogyakarta.jpg" alt="Fotografi Alam" width={700} height={400} className="h-48 w-full object-cover rounded-t-lg"/>
                ...
                <div className="bg-transparent border-2 border-dashed border-white rounded-lg shadow-lg p-5 h-85 flex flex-col items-center justify-center">
                    <h2 className="text-5xl font-semibold text-[#2B2945]">+</h2>
                    <p className="text-[#2B2945] mt-2">Coba buat plan baru disini</p>
                    <button className="mt-4 bg-[#2B2945] text-white rounded px-4 py-2 hover:bg-[#1F1E37] bg-opacity-75 hover:bg-opacity-100">Tambah Plan</button>
                </div>
            </div>
        </div>
        </section>
